...
class Place(BaseModel, Base):
    ...
    @property
    def reviews(self):
        """Getter attribute review that returns the list of Review instances
    ...
    @property
    def amenities(self):
        """Getter attribute that return the list of Amenity instances based on
    ...
    def amenities(self, obj):
        """Setter attribute that handle append method for adding an Amenity.id
